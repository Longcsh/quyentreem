...
// Tổng số tài liệu và tổng số trang (luôn hiển thị 4 trang)
...
<div class="page-content">
  <h2>GIÁO DỤC AN TOÀN CHO TRẺ</h2>
  ...
  <div class="pagination">
    <?php if ($page > 1): ?>
      <a href="?page=giaoducantoan&p=<?= $page - 1 ?>" class="prev">« Trước</a>
    <?php endif; ?>
    ...
    <?php if ($page < $totalPages): ?>
      <a href="?page=giaoducantoan&p=<?= $page + 1 ?>" class="next">Sau »</a>
    <?php endif; ?>
  </div>
</div>

<!-- ================== SCRIPT ẨN/HIỆN BÌNH LUẬN + XEM TÀI LIỆU ================== -->
...
// 📥 Khi ấn XEM TÀI LIỆU thì hiển thị nội dung và nút tải xuống
